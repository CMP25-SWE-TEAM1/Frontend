...
const App = () => {
  ...
  return (
    <div className="app relative flex min-h-[100vh] w-fit flex-col-reverse bg-white text-black dark:bg-black dark:text-white max-xs:max-w-[475px] xs:h-[100vh] xs:w-full xs:flex-row">
      <BrowserRouter>
