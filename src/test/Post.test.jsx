...
describe("Post", () => {
  ...
  test("Post render correctly", () => {
    render(
      <BrowserRouter>
        <Post
          userName={postTst.userName}
          userTag={postTst.userTag}
          date={postTst.date}
          replyCount={postTst.replyCount}
          repostCount={postTst.repostCount}
          likeCount={postTst.likeCount}
          viewCount={postTst.viewCount}
        />
      </BrowserRouter>
    );
