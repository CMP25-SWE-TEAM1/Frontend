  ...
  return (
    <div id="signInButton">
      {profile ? (
        ...
        <button onClick={() => login()} className="flex h-[2.5rem] w-full items-center justify-center rounded-3xl bg-white text-black hover:bg-lightHover dark:hover:bg-darkHover border border-ternary transition-colors">
