...
const Home = () => {
  ...
  return (
    <div className="text-center shrink-0 w-[85%] sm:w-[600px] border ml-0 mr-1 max-w-[600px] border-t-0 border-b-0 dark:border-gray-600 border-gray-100 overflow-y-scroll home">
