...
const MobileSettings = () => {
  ...
  function handleSearch(current_search) {
    document.getElementById("m-settings-no-results").classList.remove("hidden")
    ...
    options.forEach((option) => {
      ...
      if (current_search && title.toLowerCase().includes(current_search.toLowerCase())) {
        ...
        document.getElementById("m-settings-no-results").classList.add("hidden")
      }
    })
  }
  ...
  function cancelSearch() {
    setSearch("")
    document.getElementById("m-cancel-search").classList.add("hidden")
    ...
    <div className="flex h-screen dark:bg-black dark:text-white lg:hidden">
      <div className="flex h-full w-[600px] flex-col border-lightBorder dark:border-darkBorder">
        ...
        <div className="flex w-full">
          <ArrowBackIcon id="m-cancel-search" className="ml-2 mt-2 hidden h-10 w-10 rounded-full p-2 hover:cursor-pointer hover:bg-lightHover dark:hover:bg-darkHover" onClick={cancelSearch}></ArrowBackIcon>
        ...
        <div className="m-auto mt-5 hidden w-full" id="m-settings-no-results">
          {search === "" && (
            <div>
