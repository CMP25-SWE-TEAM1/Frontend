...
const PasswordReset = () => {
  ...
  return (
    <div className="m-auto h-[80vh] bg-black text-white md:rounded-2xl">
      ...
      <div id="page1" className="pop-up">
        ...
        <button type="button" id="next1" className="btn mt-28 h-14" onClick={handleNext1} disabled={userName === ""}>
          Next
        </button>
      </div>
