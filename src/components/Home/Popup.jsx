...
function Popup({ openMenu, handleMenuButtonClick, permissionOptions, replyPermissionIndex, anchorPostMenu, handleMenuClose, handleMenuItemClick, htmlElement }) {
  ...
  return (
    <div>
      <Button target={"_blank"} color={"text-" + getColor(themeColor)} size="sm" variant="plain" id="basic-button" data-testid="menu-button" aria-controls={openMenu ? "basic-menu" : undefined} aria-haspopup="true" aria-expanded={openMenu ? "true" : undefined} onClick={handleMenuButtonClick} className="my-3 rounded-full bg-transparent py-0 hover:bg-[#e7f5fd] dark:bg-transparent dark:hover:bg-[#031018]">
