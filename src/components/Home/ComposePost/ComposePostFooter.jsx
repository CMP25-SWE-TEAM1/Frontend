  ...
  return (
    <div className="flex items-center justify-between pt-3">
      <div className="flex bg-transparent">
        ...
        <GeneralButton name={<GifBoxOutlinedIcon fontSize="small" />} title="GIF" color={"text-" + getColor(themeColor)} hoverBgColor="bg-[#e7f5fd]" darkHoverBgColor="bg-[#031018]" height="h-8" width="w-8" link="/compose/tweet" disabled={GIFDisabled} disabledColor="text-[#b0dbf9] dark:text-[#0D4A73]" />
        <GeneralButton name={<BallotOutlinedIcon fontSize="small" />} title="Poll" color={"text-" + getColor(themeColor)} hoverBgColor="bg-[#e7f5fd]" darkHoverBgColor="bg-[#031018]" height="h-8" width="w-8" link="/compose/tweet" disabled={pollDisabled} disabledColor="text-[#b0dbf9] dark:text-[#0D4A73]" other={`${buttonName === "Post" ? "" : "hidden"}`} />
        <GeneralButton name={<SentimentSatisfiedOutlinedIcon fontSize="small" />} title="Emoji" color={"text-" + getColor(themeColor)} hoverBgColor="bg-[#e7f5fd]" darkHoverBgColor="bg-[#031018]" height="h-8" width="w-8" link="/compose/tweet" />
        <GeneralButton name={<EditCalendarIcon fontSize="small" />} title="Schedule" color={"text-" + getColor(themeColor)} hoverBgColor="bg-[#e7f5fd]" darkHoverBgColor="bg-[#031018]" height="h-8" width="w-8" link="/compose/tweet" disabled={false} disabledColor="text-[#b0dbf9] dark:text-[#0D4A73]" other={`${buttonName === "Post" ? "" : "hidden"}`} />
        <GeneralButton name={<LocationOnOutlinedIcon fontSize="small" />} title="Location" color={"text-" + getColor(themeColor)} hoverBgColor="bg-[#e7f5fd]" darkHoverBgColor="bg-[#031018]" height="h-8" width="w-8" link="/compose/tweet" disabled={true} disabledColor="text-[#b0dbf9] dark:text-[#0D4A73]" />
      </div>
